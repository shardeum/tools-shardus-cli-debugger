...
describe('Commands Module', () => {
  ...
  describe('get command', () => {
    it('should register the get command with correct arguments', () => {
      ...
      expect(mockProg.argument).toHaveBeenCalledWith('[instanceDir]', 'Path to unpack the instances debug data into. Unpacks into current path if not given');
  ...
  describe('collect command', () => {
    it('should register the collect command with correct arguments', () => {
      ...
      expect(mockProg.argument).toHaveBeenCalledWith('<instanceUrl>', 'URL of an instance in the network to download debug info from');
      expect(mockProg.argument).toHaveBeenCalledWith('[networkDir]', 'Path to put all network instances debug info into. Uses current path if not given');
  ...
  describe('combine command', () => {
    it('should register the combine command with correct arguments', () => {
      ...
      expect(mockProg.argument).toHaveBeenCalledWith('<networkDir>', 'A path containing multiple instanceDirs with logs');
